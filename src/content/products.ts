...
/* ===========================================================================
   ...
   represents actual Kanchi Vastra merchandise or pricing, and all of it
...
export const products: Product[] = [
  ...
  },
  {
    ...
    story:
      'If Kanchi Vastra had a single saree to stand for the rest, this would be it — a deep wine ground, a near-black border joined by hand, and a pallu closed with a run of peacock plumes. Traditional in every particular, and cut without excess.',
    specs: {
      length: '6.5 metres including blouse piece',
      width: '48 inches',
      blouse: '0.9 metre contrast blouse piece attached',
